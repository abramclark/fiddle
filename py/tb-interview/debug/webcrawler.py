...
class WebCrawler(object):
    ...
    def url_should_be_crawled_as_node(self, url):
        ...
        # prevent you frcrawler.crawl("http://triplebyte.github.io/web-crawler-test-site/test3/", None, True)om starting to crawl FTP if you're looking at HTTP
        if url_tuple[0][:4] != domain_tuple[0][:4]:
            return False
